...
public class QueryProcessorTest {
    ...
    @Test
    public void knowsMinus3() throws Exception {
        assertThat(queryProcessor.process("what is 19 minus 13"),
                containsString("6"));
    }
    ...
    @Test
    public void knowsFibo2() throws Exception {
        assertThat(queryProcessor.process("what is the 8th number in the Fibonacci sequence"),
                containsString("13"));
    }
